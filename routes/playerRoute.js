...
const playerRoutePlugin = function (fastify, _, done) {
    fastify.route({
        method: 'POST',
        url: '/Login',
        handler: playerController.login,
        schema: {
            body: playerSchema.loginSchema.body
        }
    });
    fastify.route({
        method: 'POST',
    ...
    fastify.route({
        ...
        schema: {
            body: playerSchema.clientClassSchema.body
        }
    });
    fastify.route({
        method: 'POST',
        ...
        schema: {
            body: playerSchema.rewardSchema.body
        }
    });
    fastify.route({
        method: 'POST',
    ...
    fastify.route({
        ...
        schema: {
            body: playerSchema.punishClientSchema.body
        }
    });
    fastify.route({
        method: 'POST',
        ...
        schema: {
            body: playerSchema.getMatchesSchema.body
        }
    });
    fastify.route({
        method: 'POST',
        ...
        schema: {
            body: playerSchema.punishSchema.body
        }
    });
    fastify.route({
        method: 'POST',
        ...
        schema: {
            body: playerSchema.removePunishmentSchema.body
        }
    });
    fastify.route({
        method: 'POST',
        ...
        schema: {
            body: playerSchema.unknownSalesPackageSchema.body
        }
    });
    done()
}
